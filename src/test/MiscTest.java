...
public class MiscTest
{
	...
	{
		ComputeUnit ca = new LinearUnit("", 0, null);
		ComputeUnit cb = new SigmoidUnit("");
		cb.input = new DataUnit("", new FloatMat(3, 2));
		PP.p(cb.input.dim());
		PP.p(ca.getClass().getSimpleName(), cb.getClass().getSimpleName());
		System.exit(0);
