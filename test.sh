...
if [[ $# -ne 0 && $1 == "c" ]]; then
java -jar "E:/Dropbox/Programming/Java/JarvisJava/BabelGPU/native/javacpp.jar" gpu/Natives gpu/Thrust gpu/NativeStruct -properties windows-x86_64-cuda #> stderr.log
